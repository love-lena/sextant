...
#
# Environment the dispatcher provides (see clients/go/apps/dispatch/main.go spawn()):
...
#                         (clients/ts/pi/dist/src/index.js) -- REQUIRED
...
: "${SEXTANT_PI_EXTENSION:?export SEXTANT_PI_EXTENSION=path/to/clients/ts/pi/dist/src/index.js before the dispatcher}"
