        ...
        <main className="sx-stage">
          ...
          {stageMode==="home" ? (
            ...
            <div className="sx-canvas sx-canvas--list">
              <div className="sx-page sx-page--doc"><ArtifactsView artifacts={artsShown} activeArtifact={activeArtifact} onOpenArtifact={openArtifact} onDM={startDM} /></div>
            </div>
          ) : stageMode==="goals" ? (
            <div className="sx-canvas sx-canvas--list">
              <div className="sx-page sx-page--doc"><GoalsView key={goalsEpoch} goals={goalsShown} initialGoalId={goalsOpenId} self={self} onOpenArtifact={openArtifact} onSetReview={setReview} onDM={startDM} renderWiki={renderWiki} /></div>
            </div>
          ) : stageMode==="workengine" ? (
            <div className="sx-canvas sx-canvas--list">
