...
(() => {
  ...
  const stylesheet =
    ...
    '  font:13px/1.3 system-ui,-apple-system,sans-serif;color:var(--slot-fg,rgba(0,0,0,.55));width:240px;height:160px}' +
    ...
    '.empty .sub u{text-underline-offset:2px;text-decoration-color:var(--slot-ring,rgba(0,0,0,.25))}' +
    '.empty:hover .sub u{color:var(--slot-fg,rgba(0,0,0,.75));text-decoration-color:currentColor}' +
    ':host([data-over]) .frame{outline:2px solid #c96442;outline-offset:-2px;' +
    '  background:rgba(201,100,66,.10)}' +
    '.ring{position:absolute;inset:0;pointer-events:none;border:1.5px dashed var(--slot-ring,rgba(0,0,0,.25));' +
