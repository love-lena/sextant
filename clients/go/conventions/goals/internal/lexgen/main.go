...
//
// Run it through `go generate ./clients/go/conventions/goals/...` or `make
...
// lexiconFile is the goal lexicon, relative to the goals package dir this runs
// in (go generate sets cwd to the directive's package: clients/go/conventions/goals).
...
func render(rec objectDef) ([]byte, error) {
	...
	b.WriteString("// Code generated by clients/go/conventions/goals/internal/lexgen from\n")
	...
	b.WriteString("// `go generate ./clients/go/conventions/goals/...`) after editing the lexicon;\n")
