...
status: Done
assignee: []
created_date: '2026-05-26 16:15'
labels:
  - feature
  - cli
  - ergonomics
  - polish
  - 'slug:feat-sextant-help-flags-per-subcommand'
  - P3
  - wontfix
dependencies: []
priority: low
...
<!-- SECTION:NOTES:BEGIN -->
Migrated from plans/issues/feat-sextant-help-flags-per-subcommand.md
Discovered in: chat TUI Checkpoint C — `sextant conversation --help` was broken; the fix wired conversation's fs.Usage but the other subcommands still emit nothing
Original created_at: 2026-05-26T16:15-07:00
