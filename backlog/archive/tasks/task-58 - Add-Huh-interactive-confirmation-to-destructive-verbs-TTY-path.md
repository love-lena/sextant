...
labels:
  ...
  - polish
  - charm
  - 'slug:feat-cli-huh-interactive-confirm'
  - P3
  - 'closed:fixed'
dependencies: []
priority: low
...
<!-- SECTION:NOTES:BEGIN -->
Migrated from plans/issues/feat-cli-huh-interactive-confirm.md
Discovered in: implementing feat-cli-destructive-op-flags — shipped --dry-run + --yes but skipped the TTY+Huh interactive confirm; charmbracelet/huh isn't in go.mod yet
Original created_at: 2026-05-26T23:50-07:00
Fixed in: 4b7f882
<!-- SECTION:NOTES:END -->
