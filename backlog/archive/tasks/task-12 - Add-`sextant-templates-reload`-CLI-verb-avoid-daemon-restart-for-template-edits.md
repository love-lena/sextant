...
id: TASK-12
title: >-
  Add `sextant templates reload` CLI verb (avoid daemon restart for template
  edits)
status: Done
assignee: []
...
<!-- SECTION:NOTES:BEGIN -->
Migrated from plans/issues/feat-templates-reload-cli-verb.md
Discovered in: operator workflow (lead.toml creation)
