...
labels:
  ...
  - ergonomics
  - macos
  - 'slug:docs-install-via-make-install-not-cp'
  - P3
  - 'closed:fixed'
dependencies: []
priority: low
...
<!-- SECTION:NOTES:BEGIN -->
Migrated from plans/issues/docs-install-via-make-install-not-cp.md
Discovered in: post-overnight rebuild + reinstall surprise
