...
id: TASK-14
title: >-
  Sidecar SDK driver doesn't set permissionMode — agents can't write/edit/bash
  without a granter
status: Done
assignee: []
created_date: '2026-05-25 00:24'
labels:
  - bug
  - sidecar
  - sdk-wireup
  - permissions
  - 'slug:bug-sidecar-doesnt-set-permission-mode'
  - P1
  - 'closed:resolved'
dependencies: []
priority: high
...
<!-- SECTION:NOTES:BEGIN -->
Migrated from plans/issues/bug-sidecar-doesnt-set-permission-mode.md
Discovered in: first sextant-driven dispatch attempt
Original created_at: 2026-05-25T00:24-07:00
Resolved at: 2026-05-25T00:34-07:00
<!-- SECTION:NOTES:END -->

## Final Summary

<!-- SECTION:FINAL_SUMMARY:BEGIN -->
spawn handler maps template permission_ceiling to SEXTANT_PERMISSION_MODE env var; sidecar reads it and passes permissionMode to sdkOpts
