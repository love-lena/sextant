...
labels:
  ...
  - build
  - ergonomics
  - 'slug:feat-doctor-stale-binary-detection'
  - P3
  - 'closed:resolved'
dependencies: []
priority: low
...
<!-- SECTION:NOTES:BEGIN -->
Migrated from plans/issues/feat-doctor-stale-binary-detection.md
Discovered in: post-wire-up validation (installed binary was stale from before commits)
