...
id: TASK-23
title: >-
  client.toml NATS port hardcoded to 4222 — goes stale when sextantd
  auto-allocates a different port
status: Done
assignee: []
...
labels:
  ...
  - config
  - client-libraries
  - 'slug:bug-clienttoml-stale-port-on-restart'
  - P2
  - 'closed:fixed'
dependencies: []
priority: medium
...
<!-- SECTION:NOTES:BEGIN -->
Migrated from plans/issues/bug-clienttoml-stale-port-on-restart.md
Discovered in: post-overnight daily-drive setup
Original created_at: 2026-05-25T14:53-07:00
Fixed in: ee663f52397dcb4b95ddef3d2c5e86986a25d5f2
<!-- SECTION:NOTES:END -->
