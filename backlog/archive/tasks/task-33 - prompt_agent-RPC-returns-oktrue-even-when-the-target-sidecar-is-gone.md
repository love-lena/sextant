...
labels:
  ...
  - rpc
  - operator-experience
  - 'slug:bug-prompt-agent-accepts-when-sidecar-gone'
  - P1
  - 'closed:resolved'
dependencies: []
priority: high
...
<!-- SECTION:NOTES:BEGIN -->
Migrated from plans/issues/bug-prompt-agent-accepts-when-sidecar-gone.md
Discovered in: chat TUI Checkpoint C — sent prompts to an agent whose container had exited; RPC succeeded, no frames ever arrived, `ask` timed out
Original created_at: 2026-05-26T15:05-07:00
Resolved at: 2026-05-26T22:30-07:00
<!-- SECTION:NOTES:END -->
