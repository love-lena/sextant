...
id: TASK-75
title: >-
  kill_agent CAS bail-on-conflict trips integration tests with "definition
  changed during kill (concurrent restart/archive)"
status: Done
assignee: []
created_date: '2026-05-27 20:47'
labels:
  - bug
  - daemon
  - rpc
...
<!-- SECTION:NOTES:BEGIN -->
Migrated from plans/issues/bug-kill-agent-cas-flakes-integration-tests.md
Discovered in: post-merge of kill_agent CAS migration (commit ceb0bb2) — multiple subagents running the full `make test-go` matrix on 2026-05-27 hit identical failures in `cmd/sextantd` integration tests; reproduces on `main` with no local changes
Original created_at: 2026-05-27T20:47-07:00
Fixed in: 925fb19
<!-- SECTION:NOTES:END -->
