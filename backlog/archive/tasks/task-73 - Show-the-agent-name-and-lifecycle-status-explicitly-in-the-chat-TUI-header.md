...
labels:
  ...
  - polish
  - observability
  - 'slug:feat-tui-chat-header-name-and-lifecycle'
  - P3
  - 'closed:fixed'
dependencies: []
priority: low
...
<!-- SECTION:NOTES:BEGIN -->
Migrated from plans/issues/feat-tui-chat-header-name-and-lifecycle.md
Discovered in: post-lifecycle-truth smoke testing — the header today carries a color-coded dot whose semantics ("destructive" red could mean ended, crashed, OR lost) are invisible to anyone who hasn't memorized the mapping; the agent name is shown but the lifecycle state itself is not
Original created_at: 2026-05-27T19:48-07:00
Fixed in: 8112131
<!-- SECTION:NOTES:END -->
