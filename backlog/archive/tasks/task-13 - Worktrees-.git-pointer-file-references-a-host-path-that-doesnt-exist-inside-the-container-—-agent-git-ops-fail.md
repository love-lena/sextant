...
id: TASK-13
title: >-
  Worktree's .git pointer file references a host path that doesn't exist inside
  the container — agent git ops fail
status: Done
assignee: []
created_date: '2026-05-24 23:58'
labels:
  - bug
  - worktree
  - container
...
<!-- SECTION:NOTES:BEGIN -->
Migrated from plans/issues/bug-worktree-gitdir-unreachable-in-container.md
Discovered in: first sextant-driven dispatch attempt
Original created_at: 2026-05-24T23:58-07:00
