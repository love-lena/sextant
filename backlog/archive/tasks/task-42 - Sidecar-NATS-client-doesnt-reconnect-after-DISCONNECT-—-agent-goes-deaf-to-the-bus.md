...
id: TASK-42
title: >-
  Sidecar NATS client doesn't reconnect after DISCONNECT — agent goes deaf to
  the bus
status: Done
assignee: []
created_date: '2026-05-26 17:30'
labels:
  - bug
  - sidecar
  - nats
  - resilience
  - network
  - 'slug:bug-sidecar-nats-disconnect-no-reconnect'
  - P1
  - 'closed:fixed'
dependencies: []
priority: high
...
<!-- SECTION:NOTES:BEGIN -->
Migrated from plans/issues/bug-sidecar-nats-disconnect-no-reconnect.md
Discovered in: chat TUI Checkpoint C — laptop slept, came back, assistant agent stopped responding; daemon and container still healthy
Original created_at: 2026-05-26T17:30-07:00
Fixed in: de15098
<!-- SECTION:NOTES:END -->
