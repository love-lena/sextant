...
id: TASK-55
title: >-
  prompt_agent should refuse when sidecar heartbeat is stale (deeper safety net
  beyond lifecycle)
status: Done
assignee: []
created_date: '2026-05-26 22:30'
labels:
  - feature
  - daemon
  - rpc
  - resilience
  - operator-experience
  - 'slug:feat-prompt-agent-heartbeat-staleness'
  - P2
  - 'closed:fixed'
dependencies: []
priority: medium
...
<!-- SECTION:NOTES:BEGIN -->
Migrated from plans/issues/feat-prompt-agent-heartbeat-staleness.md
Discovered in: follow-up from [[bug-prompt-agent-accepts-when-sidecar-gone]] — lifecycle check covers clean exits; heartbeat staleness covers kill-9 / OOM / host-crash cases that bypass the lifecycle publish
Original created_at: 2026-05-26T22:30-07:00
<!-- SECTION:NOTES:END -->
