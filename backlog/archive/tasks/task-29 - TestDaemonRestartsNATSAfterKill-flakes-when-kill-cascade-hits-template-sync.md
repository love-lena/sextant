...
labels:
  ...
  - supervisor
  - nats
  - 'slug:bug-flake-daemon-restarts-nats-after-kill'
  - P3
  - 'closed:fixed'
dependencies: []
priority: low
...
<!-- SECTION:NOTES:BEGIN -->
Migrated from plans/issues/bug-flake-daemon-restarts-nats-after-kill.md
Discovered in: 2026-05-25 module-rename verification run (1 failure in 1 full-package run; 3/3 passes on isolated retry)
Original created_at: 2026-05-25T17:40-07:00
Fixed in: d207cd7
<!-- SECTION:NOTES:END -->
