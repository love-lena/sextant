...
id: TASK-21
title: >-
  Sidecar bash classifier `curl|wget … | sh` denylist is bypassed by
  intermediate pipes (`| tee | bash`)
status: Done
assignee: []
...
<!-- SECTION:NOTES:BEGIN -->
Migrated from plans/issues/bug-classifier-curl-multipipe-bypass.md
Discovered in: post-cf8cbed quality review (medium-severity finding)
