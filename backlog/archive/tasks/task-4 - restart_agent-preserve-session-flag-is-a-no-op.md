...
labels:
  ...
  - restart
  - session-continuity
  - 'slug:bug-restart-preserve-session-noop'
  - P1
  - 'closed:resolved'
dependencies: []
priority: high
...
<!-- SECTION:NOTES:BEGIN -->
Migrated from plans/issues/bug-restart-preserve-session-noop.md
Discovered in: post-wire-up code reading
