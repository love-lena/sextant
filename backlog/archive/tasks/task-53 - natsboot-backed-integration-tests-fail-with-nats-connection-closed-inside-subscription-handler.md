...
id: TASK-53
title: >-
  natsboot-backed integration tests fail with "nats: connection closed" inside
  subscription handler
status: Done
assignee: []
created_date: '2026-05-26 22:00'
labels:
  - bug
  - test
  - natsboot
  ...
  - observability
  - reference
  - 'slug:bug-natsboot-test-harness-flake'
  - P3
  - wontfix
dependencies: []
priority: low
...
<!-- SECTION:NOTES:BEGIN -->
Migrated from plans/issues/bug-natsboot-test-harness-flake.md
Discovered in: writing TestLifecycleWatcherUpdatesAgentRecord — the natsboot harness boots, the test's own Put succeeds, but the watcher's NATS callback handler hits `nats: connection closed` on its Get against the same `defs jetstream.KeyValue` handle
Original created_at: 2026-05-26T22:00-07:00
Resolved at: 2026-05-28T11:13-07:00
<!-- SECTION:NOTES:END -->
