...
id: TASK-22
title: >-
  Sidecar bash classifier denies `rm -rf` anywhere — blocks legitimate `rm -rf
  /tmp/somedir`
status: Done
assignee: []
...
labels:
  ...
  - classifier
  - permissions
  - 'slug:bug-classifier-rm-rf-too-broad'
  - P3
  - 'closed:fixed'
dependencies: []
priority: low
...
<!-- SECTION:NOTES:BEGIN -->
Migrated from plans/issues/bug-classifier-rm-rf-too-broad.md
Discovered in: dev-3 first sextant-driven dispatch
