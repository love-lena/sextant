...
id: TASK-43
title: >-
  Sidecar drains queued inbox on reconnect, producing flood of "orphan"
  responses with no visible originating prompts
status: To Do
assignee: []
created_date: '2026-05-26 17:35'
labels:
  - bug
  - sidecar
  - nats
  ...
  - needs-input
  - operator-experience
  - 'slug:bug-sidecar-queued-prompt-drain-orphans-context'
  - P2
dependencies: []
priority: medium
ordinal: 43000
...
<!-- SECTION:NOTES:BEGIN -->
Migrated from plans/issues/bug-sidecar-queued-prompt-drain-orphans-context.md
Discovered in: chat TUI Checkpoint C — after `agents restart` resolved a NATS disconnect, the chat filled with response frames from prompts the operator had sent during the disconnect window
Original created_at: 2026-05-26T17:35-07:00
<!-- SECTION:NOTES:END -->
