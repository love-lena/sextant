...
// protocol/conformance/vectors/spawn/ from one well-known location — the SAME JSON
...
// spawnVectorsDir is the directory holding the spawn op-transcript conformance
// vectors — the protocol-owned, language-neutral files.
export function spawnVectorsDir(): string {
  return join(repoRoot(), "protocol", "conformance", "vectors", "spawn");
}
