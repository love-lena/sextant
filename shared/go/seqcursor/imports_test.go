...
func TestCursorSitesDelegate(t *testing.T) {
	for _, p := range []string{
		importcheck.Module + "/clients/sextant-mcp",
		importcheck.Module + "/clients/sextant-mcp/attest",
		importcheck.Module + "/clients/assistant/internal/violet",
	} {
...
func TestAppsNoWireAtom(t *testing.T) {
	for _, p := range []string{
		importcheck.Module + "/clients/sextant-mcp",
		importcheck.Module + "/clients/coordinator",
		importcheck.Module + "/clients/assistant",
		importcheck.Module + "/clients/assistant/internal/violet",
		importcheck.Module + "/clients/sextant-tui/internal/dash",
		importcheck.Module + "/clients/sextant-dash/dashapi",
		importcheck.Module + "/clients/sextant-dash/dashserve",
	} {
